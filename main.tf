...
module Peerconnection {
    ...
    acceptervpc_cidr = module.VPC.QAvpc_cidr
    accepter_qa_vpcid = module.VPC.vpc_id
    privatesubnetroutetable = module.SUBNETS.privatesubnetroutetable_ids
    publicsubnetroutetable = module.SUBNETS.publicsubnetroutetable_ids
    peerconnectionName = var.peerconnectionName
}